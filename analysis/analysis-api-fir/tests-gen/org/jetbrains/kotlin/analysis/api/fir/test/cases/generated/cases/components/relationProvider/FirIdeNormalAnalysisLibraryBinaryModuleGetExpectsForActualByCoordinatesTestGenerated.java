...
public class FirIdeNormalAnalysisLibraryBinaryModuleGetExpectsForActualByCoordinatesTestGenerated extends AbstractGetExpectsForActualByCoordinatesTest {
  @NotNull
  @Override
  ...
  public class IncorrectMatching {
    ...
    public void testAllFilesPresentInIncorrectMatching() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/components/relationProvider/getExpectsForActual/incorrectMatching"), Pattern.compile("^(.+)\\.(kt)$"), null, true);
    }
  ...
  public class Stdlib {
    ...
    public void testAllFilesPresentInStdlib() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/components/relationProvider/getExpectsForActual/stdlib"), Pattern.compile("^(.+)\\.(kt)$"), null, true);
    }
