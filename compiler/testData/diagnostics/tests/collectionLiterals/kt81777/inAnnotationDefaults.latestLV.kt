...
annotation class LamInt(val e: Int = <!ANNOTATION_PARAMETER_DEFAULT_VALUE_MUST_BE_CONSTANT, UNRESOLVED_REFERENCE!>[{}]<!>)
...
annotation class AnonInt(val e: Int = <!ANNOTATION_PARAMETER_DEFAULT_VALUE_MUST_BE_CONSTANT, UNRESOLVED_REFERENCE!>[fun() {}]<!>)
annotation class AnonIntArray(val e: IntArray = [<!ARGUMENT_TYPE_MISMATCH!>fun() {}<!>])
annotation class AnonArrayString(val e: Array<String> = [<!ARGUMENT_TYPE_MISMATCH, ARGUMENT_TYPE_MISMATCH, ARGUMENT_TYPE_MISMATCH!>fun() {}<!>])
