...
fun tst() {
    ...
    buildBox {
        get { <!EXPECTED_PARAMETER_TYPE_MISMATCH("Int; uninferred T (of fun <T> buildBox)")!>x: Int<!>, y: String -> }
        put(42)
    }
    ...
    buildBox {
        get { <!EXPECTED_PARAMETER_TYPE_MISMATCH("Int; uninferred T (of fun <T> buildBox)")!>x<!>, y: String -> }
        put(42)
    }
}
