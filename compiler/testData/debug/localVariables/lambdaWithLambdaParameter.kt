...
// test.kt:7 $Foo.start: $<this>:(ref $Foo)=(ref $Foo) (15, 15, 15, 15, 15, 8, 8, 8)
...
// test.kt:7 $Foo$start$lambda.invoke: $$this:(ref $Foo)=(ref $Foo) (15, 15)
// test.kt:8 $Foo$start$lambda.invoke: $$this:(ref $Foo)=(ref $Foo) (12, 12, 12, 19, 19, 19, 12, 12, 12)
// test.kt:7 $Foo$start$lambda.invoke: $$this:(ref $Foo)=(ref $Foo) (15)
