...
// test.kt:8 $box$lambda.invoke: $$this$blockFun:(ref $kotlin.String)=(ref $kotlin.String) (14, 14, 14)
// test.kt:9 $box$lambda.invoke: $$this$blockFun:(ref $kotlin.String)=(ref $kotlin.String) (18, 18)
// test.kt:8 $box$lambda.invoke: $$this$blockFun:(ref $kotlin.String)=(ref $kotlin.String) (14)
