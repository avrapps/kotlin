...
// test.kt:8 $box$lambda.invoke: $$this$label:(ref $kotlin.String)=(ref $kotlin.String) (19, 19, 19)
// test.kt:9 $box$lambda.invoke: $$this$label:(ref $kotlin.String)=(ref $kotlin.String) (8, 8)
// test.kt:8 $box$lambda.invoke: $$this$label:(ref $kotlin.String)=(ref $kotlin.String) (19)
